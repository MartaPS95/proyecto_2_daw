...
?>
	<body class = "body">
		...
		//  echo "<th bgcolor=Green>NOMBRE</th><th bgcolor=Red>EDAD</th><th bgcolor=lightblue>ELIMINAR LA CLASE</th></TR>";
		...
		echo "<a class='button is-primary' href='profesores.php?e=".$renglon['id']."'>Eliminar</a>&nbsp&nbsp<a class='button is-primary' href='profesores.php?m=".$renglon['id']."'>Modificar</a>";
