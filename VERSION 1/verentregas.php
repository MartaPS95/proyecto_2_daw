...
if(isset($_REQUEST['idtareanota']) && !empty($_REQUEST['idtareanota']) && isset($_REQUEST['nota']) && !empty($_REQUEST['nota'])){
    ...
    <section class = "section">
      <?php
        ...
        /*   $queryplan = "SELECT * FROM ".$tabla." WHERE idplanificacion=" . $_SESSION['idtarea'];
           ...
           $querynombre = "SELECT * FROM ".$tabla.", ".$tabla2." WHERE alumnos.email=entregas.usuario AND idplanificacion=" . $_SESSION['idtarea'];
...
echo "<strong><p>Tarea entegada por: ".$renglon['nombre']. " ".$renglon['apellido']." ".$renglon['segApellido']."</p></strong>";
